...
def get_balance(db: Session = Depends(get_db)):
    income = db.query(models.Transaction).filter(models.Transaction.category == 'income').all()
    expense = db.query(models.Transaction).filter(models.Transaction.category == 'expense').all()
